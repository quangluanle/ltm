	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for (Product p : products) {
			out.println("				<div class=\"col-md-6 col-lg-3 fadeInUp ftco-animate ftco-animated\">\r\n"
					+ "						<div class=\"product\">\r\n"
					+ "							<a href=\"product-detail?id="+p.getProduct_id()+"\" class=\"img-prod\"><img\r\n"
					+ "								class=\"img-fluid\" src=\"images/"+p.getImage()+"\"\r\n"
					+ "								alt=\"Colorlib Template\"> <span class=\"status\">20%</span>\r\n"
					+ "								<div class=\"overlay\"></div> </a>\r\n"
					+ "							<div class=\"text py-3 pb-4 px-3 text-center\">\r\n"
					+ "								<h3>\r\n"
					+ "									<a href=\"product-detail?id="+p.getProduct_id()+"\">"+p.getName()+"</a>\r\n"
					+ "								</h3>\r\n"
					+ "								<div class=\"d-flex\">\r\n"
					+ "									<div class=\"pricing\">\r\n"
					+ "										<p class=\"price\">\r\n"
					+ "											<span class=\"mr-2 price-dc\">$"+p.getPrice() / 0.8 +"</span><span\r\n"
					+ "												class=\"price-sale\">$"+p.getPrice()+"</span>\r\n"
					+ "										</p>\r\n"
					+ "									</div>\r\n"
					+ "								</div>\r\n"
					...
					+ "										</a> <a href=\"add-to-cart?id="+p.getProduct_id()+"&quantity=1\"\r\n"
