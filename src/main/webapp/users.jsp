										...
										<tr>
											...
											<td>
												<div style="display: flex;">
													<a href="UpdateProduct?id=${p.phoneNumber}"
														style="text-decoration: none; margin-top: 5px"> <img
														alt="" src="images/edit.png" width="20" height="20">
													</a> <a href="DeleteProduct?id=${p.phoneNumber}"
														style="text-decoration: none; margin-top: 5px; margin-left: 15px">
